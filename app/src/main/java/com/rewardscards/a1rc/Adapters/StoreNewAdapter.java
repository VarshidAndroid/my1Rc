...
public class StoreNewAdapter extends RecyclerView.Adapter<StoreNewAdapter.ViewHolder> {

    ArrayList<NewProuctAdResponse.Datum> productList;

    Context context;

    public StoreNewAdapter(Context context, ArrayList<NewProuctAdResponse.Datum> productList) {
    ...
    @NonNull
    @Override
    public StoreNewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.store_product_item, null);
        StoreNewAdapter.ViewHolder viewHolder = new StoreNewAdapter.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull StoreNewAdapter.ViewHolder holder, final int position) {

        holder.main_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPrefsUtils.setSharedPreferenceString(context,"product_id",productList.get(position).getProductId());
